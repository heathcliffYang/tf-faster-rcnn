...
from utils.blob import prep_im_for_blob, prep_mask_for_blob, im_list_to_blob

def get_minibatch(roidb, num_classes):
  """Given a roidb, construct a minibatch sampled from it."""

  # Get the input image blob, formatted for caffe
  im_blob, im_scales = _get_image_blob(roidb, 0)#random_scale_inds)
  blobs = {'data': im_blob}
  ...
  gt_masks = roidb['masks'][gt_inds]
  blobs['gt_masks'] = prep_mask_for_blob(gt_masks, blobs['im_info'])
  return blobs
